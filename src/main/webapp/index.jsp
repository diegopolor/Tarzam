        ...
        <main class="container">
            <div class="form-container">
                ...
                <form action="" class="form">
                    ...
                    <input type="text" name="txtUser" placeholder="Introducir usuario" class="forminput">
                    <label for="" class="formtxt formlabel">Contraseña</label>
                    <input type="password" name="txtPassword" placeholder="Introducir contraseña" class="forminput">
